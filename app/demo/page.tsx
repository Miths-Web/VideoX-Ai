          ...
          <Card className="overflow-hidden">
            <div className="relative aspect-video bg-black">
              <Tabs value={activeTab} onValueChange={handleTabChange} className="absolute inset-0">
                ...
                <TabsList className="absolute bottom-4 right-4 bg-background/80 backdrop-blur-sm z-10">
        ...
        <div>
          ...
          <div className="space-y-4">
            {demoVideos.map((video) => (
              <Card
                key={video.id}
                className={`overflow-hidden cursor-pointer transition-all hover:shadow-md ${activeVideo.id === video.id ? 'ring-2 ring-primary' : ''
                  }`}
